...
#
#   curl https://raw.githubusercontent.com/tuzzeg/.dotfiles/master/install.sh | sh
#
# or:
#
#   ~/.dotfiles/install.sh
...
bindir=$HOME/bin
gitbase=git://github.com/tuzzeg/.dotfiles.git
tarball=http://github.com/tuzzeg/.dotfiles/tarball/master
